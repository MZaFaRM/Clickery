...
def _wait_window():
    ...
    Waits_spinbox.configure(background=tkwindow.ContentColor, foreground=tkwindow.TextColor)
    Waits_label.configure(background=tkwindow.ContentColor, foreground=tkwindow.TextColor)
